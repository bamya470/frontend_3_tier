...
sudo aws s3 cp s3://hypha-hypha-bucket/app.js /var/www/html/
sudo aws s3 cp s3://hypha-hypha-bucket/package.json /var/www/html/
sudo aws s3 cp s3://hypha-hypha-bucket/package-lock.json /var/www/html/
sudo aws s3 cp --recursive s3://hypha-hypha-bucket/node_modules /var/www/html/node_modules
